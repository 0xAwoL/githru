...
// import { styled, styled } from '@mui/material/styles';
...
// Simple branch visibility controls
const ManageParameters = () => {
    return (
        <div style={{padding: '10px', fontSize: '12px'}}>
            <div style={{fontWeight: 'bold', marginBottom: '5px'}}>Branch Visibility:</div>
            <div>✅ Explicit branches: ON</div>
            <div>✅ Implicit branches: ON</div>
            <div>✅ Open PRs: ON</div>
            <div>❌ Merged PRs: OFF</div>
            <div>❌ Closed PRs: OFF</div>
            <div style={{marginTop: '8px', fontSize: '10px', color: '#666'}}>
                Branch names now shown as labels on graph
                </div>
            </div>
    );
};
